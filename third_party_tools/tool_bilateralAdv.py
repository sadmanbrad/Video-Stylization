...
flowFwdFormat = "flow_fwd\\" + inputFileFormat + ".A2V2f"  # path to the forward flow files (computed by third_party_tools/disflow)
flowBwdFormat = "flow_bwd\\" + inputFileFormat + ".A2V2f"  # path to the backward flow files (computed by third_party_tools/disflow)
outputFormat   = "input_filtered\\" + inputFileFormat + ".png"  # path to the result filtered sequence
frameFirst = 0                      # number of the first PNG file in the input folder
